...
# the worst possible first screenshot. `body-tab` replaced Pulse's `day` at
# 10.0.0 (Precision Q19: the tab is Body — the ring and six petals).
SCREENS="today train fuel body-tab body-trends history"
